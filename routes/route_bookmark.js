...
router.post('/addCat',(req,res)=>{ //console.log(req.body);
   Bookmark.addCat(req.body,(err,count)=>err? res.json(err): res.json(count))
});

router.delete('/category/:id',(req,res)=>{
   Bookmark.deleteCat(req.params.id, (err,rows)=>err? res.json(err): res.json(rows))
});
...
//for pass//
router.post('/getPass',(req,res)=>{  //console.log(req.body)
